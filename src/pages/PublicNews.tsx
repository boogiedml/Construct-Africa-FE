            ...
            <section className="mx-auto py-5 md:py-8 px-5 sm:px-10 lg:px-20">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2">
                        <div className='text-lg font-semibold text-[#181D27] border-b-4 mb-5 border-[#F89822] py-1 px-2 pl-0 w-fit'>Top News</div>
                        <div className="">
                    ...
                    <div className="lg:col-span-1 flex flex-col">
                        <div className='text-lg font-semibold text-[#181D27] border-b-4 mb-5 border-[#F89822] py-1 px-2 pl-0 w-fit'>Latest News</div>
